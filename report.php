            ...
            ?>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 offset-md-3 text-center">
                        <button id="printReport" class="btn btn-success">Generate Report</button>
                    </div>
                </div>

                <!-- News DataTable -->
                <div class="table-responsive" id="newsContainer">
                    <table id="newsTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr data-full="<?= htmlspecialchars($row['full_content']) ?>">
                                    <td><?= $i++ ?></td>
                                    <td><?= htmlspecialchars($row['title']) ?></td>
                                    <td><?= htmlspecialchars($row['department']) ?></td>
                                    <td><?= htmlspecialchars($row['summary']) ?></td>
                                    <td><button class="btn btn-sm btn-primary read-more">Read More</button></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function () {
        ...
        $('#printReport').on('click', function () {
            const printContents = document.getElementById('newsContainer').innerHTML;
            const originalContents = document.body.innerHTML;

            document.body.innerHTML = printContents;
            window.print();
            document.body.innerHTML = originalContents;
            location.reload(); // Reload to bring everything back
        });
    });
</script>
<script>
